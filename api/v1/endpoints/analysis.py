        ...
        if records:
            ...
            report_dict = AnalysisReport(
                ...
                summary=ReportSummary(
                    ...
                    sentiment_label=AnalysisService()._get_sentiment_label(record.sentiment_score or 50),
...
def _build_analysis_report(
    ...
    summary = ReportSummary(
        ...
        position_action=summary_data.get("position_action"),
        target_weight=summary_data.get("target_weight"),
        current_weight=summary_data.get("current_weight"),
        delta_amount=summary_data.get("delta_amount"),
        action_reason=summary_data.get("action_reason"),
