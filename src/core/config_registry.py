...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    "STOCK_LIST": {
        "title": "Stock List",
        "description": "Comma-separated ASX/AU/US watchlist stock codes.",
        "category": "base",
        "data_type": "array",
        "ui_control": "textarea",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": Config.default_stock_list_csv(),
        "options": [],
    ...
    "EXECUTION_PRICE_POLICY": {
        "title": "Execution Price Policy",
        "description": "Execution/reference price basis policy: realtime_if_available or close_only.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
    ...
    "MIN_BUY_ORDER_NOTIONAL": {
        "title": "Minimum Buy Order Notional",
        "description": "Minimum notional amount for OPEN/ADD actions; smaller buy-side plans are shown as watch-only.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MAX_SINGLE_BUY_CASH_FRACTION": {
        "title": "Max Single Buy Cash Fraction",
        "description": "Maximum fraction of currently visible buy cash budget that one new OPEN recommendation may use.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "MAX_SINGLE_BUY_CASH_AMOUNT": {
        "title": "Max Single Buy Cash Amount",
        "description": "Optional absolute notional cap for one new OPEN recommendation; empty disables this cap.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "ASX_ANNOUNCEMENTS_ENABLED": {
        "title": "ASX Announcements Enabled",
        "description": "Enable read-only best-effort ASX official market-announcement evidence in daily reports.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "ASX_ANNOUNCEMENTS_LOOKBACK_DAYS": {
        "title": "ASX Announcements Lookback Days",
        "description": "Fetch today's ASX announcements and, when positive, the previous trading day listing at most once.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "ASX_ANNOUNCEMENTS_MAX_ITEMS": {
        "title": "ASX Announcements Max Items",
        "description": "Maximum recent ASX announcement metadata items stored per ticker in report evidence.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "ASX_ANNOUNCEMENTS_TIMEOUT_SECONDS": {
        "title": "ASX Announcements Timeout Seconds",
        "description": "HTTP timeout for each ASX announcement listing request; capped at 10 seconds.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "NEWS_INTEL_CACHE_ENABLED": {
        "title": "News Intel Cache Enabled",
        "description": "Enable reuse of recent news_intel records before calling external search providers.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "NEWS_INTEL_CACHE_DAYS": {
        "title": "News Intel Cache Days",
        "description": "Freshness window in days for cached news_intel reuse.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "NEWS_INTEL_CACHE_MIN_RESULTS": {
        "title": "News Intel Cache Min Results",
        "description": "Minimum cached results required before reusing persisted news_intel rows.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "TAVILY_API_KEYS": {
        ...
        "description": "Comma-separated Tavily API keys. Tavily advanced search is the default primary search path.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "GEMINI_GROUNDING_SEARCH_ENABLED": {
        "title": "Gemini Grounding Search Enabled",
        "description": "Enable Gemini Grounding with Google Search as the first fallback after Tavily.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "GEMINI_GROUNDING_MODEL": {
        "title": "Gemini Grounding Model",
        "description": "Gemini model used for Grounding with Google Search. Defaults to GEMINI_MODEL, then gemini-3.5-flash.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "GEMINI_GROUNDING_MAX_RESULTS": {
        "title": "Gemini Grounding Max Results",
        "description": "Maximum grounded search results requested from Gemini Grounding.",
        "category": "data_source",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SERPAPI_API_KEYS": {
        "title": "SerpAPI Keys",
        "description": "Comma-separated SerpAPI keys. Low-frequency fallback after Tavily and Gemini Grounding.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "SERPAPI_MARKET_REVIEW_FALLBACK_ENABLED": {
        "title": "SerpAPI Market Review Fallback Enabled",
        "description": "Allow market review search to use SerpAPI after Tavily and Gemini Grounding are exhausted or filtered empty. Defaults off to preserve low-frequency fallback quota.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "GEMINI_API_KEY": {
        ...
        "description": "Legacy single Gemini API key. Ignored when GEMINI_API_KEYS is set.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "GEMINI_API_KEYS": {
        ...
        "description": "Comma-separated Gemini API keys. Preferred over GEMINI_API_KEY.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "GEMINI_MODEL_FALLBACK": {
        ...
        "description": "Fallback Gemini model name.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
