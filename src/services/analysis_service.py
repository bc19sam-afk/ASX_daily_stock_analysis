    ...
    def _build_analysis_response(
        ...
        report = {
            "meta": {
                ...
                "technical_basis_date": (getattr(result, "market_snapshot", None) or {}).get("date"),
                "price_policy": getattr(result, "execution_price_source", None),
                "execution_price_source": getattr(result, "execution_price_source", None),
                "current_price": result.current_price,
                "change_pct": result.change_pct,
                "analysis_status": getattr(result, "analysis_status", "OK" if getattr(result, "success", True) else "FAILED"),
                "analysis_status_reason": getattr(result, "analysis_status_reason", None),
