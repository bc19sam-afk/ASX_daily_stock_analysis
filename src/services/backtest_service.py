...
class BacktestService:
        ...
        for analysis in candidates:
            ...
            try:
                ...
                results_to_save.append(BacktestResult(
                    ...
                    alpha_decision=evaluation.get("alpha_decision"),
                    final_decision=evaluation.get("final_decision"),
                    position_action=evaluation.get("position_action"),
                    target_weight=evaluation.get("target_weight"),
                    current_weight=evaluation.get("current_weight"),
                    delta_amount=evaluation.get("delta_amount"),
    ...
    def _build_summary_model(summary_data: Dict[str, Any]) -> BacktestSummary:
        return BacktestSummary(
            ...
            decision_accuracy_pct=summary_data.get("decision_accuracy_pct"),
            decision_win_rate_pct=summary_data.get("decision_win_rate_pct"),
    ...
    def _summary_to_dict(row: BacktestSummary) -> Dict[str, Any]:
        return {
            ...
            "decision_accuracy_pct": row.decision_accuracy_pct,
            "decision_win_rate_pct": row.decision_win_rate_pct,
